    ...
    $message2='';
        ...
        if(isset($benrg)){ 
            ...
            if(empty($message and  $message2)){
                ...
                {
                    $sql=$pdo->prepare("INSERT INTO tb_eleve(matricule,prenom,nom,sexe,dateNaissance,classe,montantPaye,quartier,contacTuteur,situation_classe,situation_ecole) 
                                               VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?,?)");                             
